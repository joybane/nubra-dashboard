...
output_path = r"e:\Derivativesproject\nubra-dashboard\src\NubraBacktest_original.tsx"
    ...
    for line in f:
        try:
            ...
            if step.get("type") == "VIEW_FILE" and step.get("source") == "MODEL":
                ...
                if "NubraBacktest.tsx" in content:
                    lines = content.split('\n')
                    for l in lines:
...
if file_content:
    ...
    print("Extracted NubraBacktest.tsx successfully with " + str(len(file_content)) + " lines.")
else:
    print("Failed to find any lines for NubraBacktest.tsx")
