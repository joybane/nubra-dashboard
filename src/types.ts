...
export interface WsPosLtpMsg {
  type: 'position_ltp';
  data: { ref_id: number; ltp: number }[];
}
...
export type WsMessage =
  WsOhlcvMsg | WsTickMsg | WsOcMsg | WsStatusMsg | WsAuthMsg | WsPosLtpMsg | WsRuleFiredMsg;
...
export type PaperOrderType =
  'ORDER_TYPE_MARKET' | 'ORDER_TYPE_REGULAR' | 'ORDER_TYPE_STOPLOSS' | 'ORDER_TYPE_ICEBERG';
