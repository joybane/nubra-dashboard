              ...
              <div className="flex gap-1">
                ...
                {stopLoss.type !== 'NONE' && (
                  <label className="w-16">
                    ...
                    <input type="number" value={stopLoss.value ?? 0} onChange={e => setStopLoss({ ...stopLoss, value: Number(e.target.value) })} className={inputCls} />
                  </label>
                )}
              </div>
              <div className="flex gap-1">
                ...
                {target.type !== 'NONE' && (
                  <label className="w-16">
                    <span className={lblCls}>Val</span>
                    <input type="number" value={target.value ?? 0} onChange={e => setTarget({ ...target, value: Number(e.target.value) })} className={inputCls} />
                  </label>
                )}
              </div>
            </div>
